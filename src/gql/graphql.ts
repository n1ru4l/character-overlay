...
export type CharacterEditorQueryQuery = { __typename?: 'Query', characterEditor?: { __typename: 'CharacterEditorView', character: (
      { __typename?: 'Character', id: string }
      & { ' $fragmentRefs': { 'CharacterViewFragmentFragment': CharacterViewFragmentFragment } }
    ) } | { __typename: 'Error', reason: string } | null | undefined };
...
export type UpdateCharacterMutationMutation = { __typename?: 'Mutation', updateCharacter?: boolean | null | undefined };

export type CharacterOverlayFragmentFragment = { __typename?: 'Character', id: string, name: string, currentHealth: number, maximumHealth: number, hasMana: boolean, currentMana: number, maximumMana: number, hasFatePoints: boolean, currentFatePoints: number, maximumFatePoints: number, imageUrl?: string | null | undefined } & { ' $fragmentName': 'CharacterOverlayFragmentFragment' };
